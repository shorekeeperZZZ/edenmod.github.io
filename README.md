...
<head>
    ...
    <meta name="description" content="Khám phá kho mod game lớn nhất dành cho cộng đồng game thủ Việt tại Eden Mod. Cung cấp thông tin, link tải và các chức năng mod chi tiết.">
    <title>Eden Mod - Kho Thông Tin Mod Game</title>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap" rel="stylesheet">
    <style>
        /* --- Cài đặt biến màu và phông chữ --- */
        :root {
            --bg-primary: #121212;
            --bg-secondary: #1e1e1e;
            --card-bg: #2a2a2a;
            ...
            --status-ok: #4caf50;        /* Xanh lá */
            --status-updating: #2196F3;  /* Xanh dương */
            --status-stopped: #f44336;   /* Đỏ */
...
<body>
  ...
  },
  {
    ...
    "status": "Hoạt động tốt",
    "note": "Chức năng mod: Damage Multiplier, Defense Multiplier, No Skill Cooldown, Speed Multiplier (Harvest rice, chop wood)."
  },
  {
